...
$id = $_GET['id'];
$query = "SELECT * FROM pos_masuk WHERE id = $id AND tipe_surat = 'dana'";
...
<html>
<head>
    <title>Edit Surat Masuk Dana - Sistem arsip surat</title>
            ...
            <div class="container py-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Surat Masuk Dana</h4>
                    </div>
                    <div class="card-body">
