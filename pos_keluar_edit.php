...
$id = $_GET['id'];
$query = "SELECT * FROM pos_keluar WHERE id = $id";
...
<head>
    <title>Edit Surat Keluar - Sistem arsip surat</title>
            ...
            <div class="container py-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Surat Keluar</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="tujuan_surat" class="form-control"
                                        value="<?php echo $data['tujuan_surat']; ?>" required>
                                </div>
